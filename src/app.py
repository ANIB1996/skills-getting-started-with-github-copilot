...
activities = {
    ...
    "Drama Club": {
        "description": "Acting exercises, rehearsals and staging school plays",
        "schedule": "Tuesdays and Fridays, 3:45 PM - 5:30 PM",
        "max_participants": 30,
        "participants": ["lucas@mergington.edu", "amelia@mergington.edu"]
    },
    # Intellectual activities
    "Debate Team": {
        "description": "Prepare for inter-school debates and learn argumentation skills",
